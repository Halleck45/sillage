...
Bouton « Ouvrir la PR » (`gh pr create`), internationalisation de l'UI, gestion des agents dans l'interface, multi-utilisateur, commande de check par projet dans l'UI.
